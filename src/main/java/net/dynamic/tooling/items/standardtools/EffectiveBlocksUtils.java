...
public class EffectiveBlocksUtils {

    public static final Set<Block> EXCAVATOR_EFFECTIVE_BLOCKS;
    public static final Set<Block> HAMMER_EFFECTIVE_BLOCKS;
    public static  final Set<Block> PATHABLE_BLOCKS;

    static {

        EXCAVATOR_EFFECTIVE_BLOCKS = Sets.newHashSet(new Block[]{
            Blocks.CLAY, Blocks.DIRT, Blocks.COARSE_DIRT,
            Blocks.PODZOL, Blocks.FARMLAND, Blocks.GRASS_BLOCK,
            Blocks.GRAVEL, Blocks.MYCELIUM, Blocks.SAND,
            Blocks.RED_SAND, Blocks.SNOW_BLOCK, Blocks.SNOW,
        ...
        HAMMER_EFFECTIVE_BLOCKS = Sets.newHashSet(new Block[]{
            Blocks.POWERED_RAIL, Blocks.GOLD_BLOCK,
            Blocks.GOLD_ORE, Blocks.ICE,
            ...
            Blocks.RAIL, Blocks.REDSTONE_ORE,
            ...
            Blocks.POLISHED_GRANITE, Blocks.DIORITE,
            Blocks.POLISHED_DIORITE, Blocks.ANDESITE,
            Blocks.POLISHED_ANDESITE, Blocks.STONE_SLAB,
            Blocks.SMOOTH_STONE_SLAB, Blocks.SANDSTONE_SLAB,
            Blocks.PETRIFIED_OAK_SLAB, Blocks.COBBLESTONE_SLAB,
            Blocks.BRICK_SLAB, Blocks.STONE_BRICK_SLAB,
            Blocks.NETHER_BRICK_SLAB, Blocks.QUARTZ_SLAB,
            Blocks.RED_SANDSTONE_SLAB, Blocks.PURPUR_SLAB,
            Blocks.SMOOTH_QUARTZ, Blocks.SMOOTH_RED_SANDSTONE,
            Blocks.SMOOTH_SANDSTONE, Blocks.SMOOTH_STONE,
            ...
            Blocks.SMOOTH_SANDSTONE_SLAB, Blocks.SMOOTH_QUARTZ_SLAB,
            Blocks.GRANITE_SLAB, Blocks.ANDESITE_SLAB,
        ...
        PATHABLE_BLOCKS = Sets.newHashSet(new Block[]{
                Blocks.GRASS_BLOCK, Blocks.GRASS_PATH
        });
    }
}
